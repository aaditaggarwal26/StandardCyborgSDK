...
rhl_woundcare::math::Mat3x4 SparseICPPointToPlane(const rhl_woundcare::sc3d::Geometry& source, const rhl_woundcare::sc3d::Geometry& target, const SparseICPParameters& pars);
